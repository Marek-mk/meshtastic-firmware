...
#define LOW_VOLTAGE_NO_DEEP_SLEEP 1 // If defined, the device will not power off when the battery voltage is low.
...
#ifdef LOW_VOLTAGE_NO_DEEP_SLEEP
                LOG_DEBUG("Low voltage NO_DEEP_SLEEP configured.");
